...
INSERT INTO `responses` VALUES (25,'Hello world',26,2,'2023-08-14 21:47:10');
...
INSERT INTO `subscribers` VALUES (1,'admin@inkscribe.com'),(2,'ssanmeet123@gmail.com');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `fetch_recommendations` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `fetch_recommendations`(
	in _type varchar(255)
)
BEGIN

declare _t int;
select id into _t from articles_type where type = _type;
...
group by article_id)
select 
	t1.id, t1.user_id, t2.name,  t2.profile_image ,t1.title, t1.slug, '' as content,t3.type, t1.created_at, t1.view_count, t1.featured_image_url,
    ...
    where t1.type = _t
    order by t1.created_at desc limit 5;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	with likes_dislikes as (select article_id ,
		...
		group by article_id)
		select 
			t1.id, t1.user_id, t2.name,  t1.title,  t2.profile_image, t1.slug, '' as content,t3.type, t1.created_at, t1.view_count, t1.featured_image_url,
			t1.description, COALESCE(likes_count, 0) as likes, COALESCE(dislikes_count ,0) as dislikes,
			null as myreaction
			from articles t1 
			inner join users t2 on t2.id = t1.user_id
...
BEGIN
	select t1.id , t2.name, content, t1.article_id, t1.user_id, t2.profile_image , t1.created_at from responses t1
...
BEGIN
	select t1.id , t2.name, t1.content, t1.article_id, t1.user_id,t2.profile_image ,t1.created_at from responses t1
	inner join users t2 on t1.user_id = t2.id
...
group by article_id)
select 
	t1.id, t1.user_id, t2.name,  t2.profile_image ,t1.title, t1.slug,  t1.content,t3.type, t1.created_at, t1.view_count, t1.featured_image_url,
    t1.description, COALESCE(likes_count, 0) as likes, COALESCE(dislikes_count ,0) as dislikes,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_n_articles` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_n_articles`(
	in n int
)
BEGIN
...
select 
	...
	inner join articles_type t3 on t1.type = t3.id 
    left join likes_dislikes t4 on t4.article_id = t1.id
    order by t1.created_at desc limit n;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2023-08-16 16:44:43
